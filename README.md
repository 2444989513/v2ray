...
```
bash <(curl -L -s https://raw.githubusercontent.com/2444989513/V2Ray_ws-tls_bash_onekey-1/master/install.sh) | tee v2ray_ins.log
```
Vmess + HTTP2 over TLS
```
bash <(curl -L -s https://raw.githubusercontent.com/2444989513/V2Ray_ws-tls_bash_onekey/master/install_h2.sh) | tee v2ray_ins_h2.log
```
## 启动方式
